# Supabase Realtime AI Assistant Prompt

Use your AI tool's include-file feature to include this prompt when chatting with your AI assistant:

- GitHub Copilot: `#supabase-realtime-ai-assistant-guide.md`
- Cursor: `@Files` then select this file
- Zed: `/file` then select this file
